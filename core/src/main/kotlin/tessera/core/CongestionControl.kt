 ...
 *
 * Tessera's primary CC is receiver-driven credit ([ReceiverCredit]/[SenderCredit]). A [SenderCc] is the
 * sender-side *fallback*: it bounds the sender before grants arrive and keeps Tessera fair with loss-based
 ...
 *
 * Differences from TCP CUBIC that follow from Tessera's environment:
