...
import tessera.core.RlncHarness
...
class NativeTest {
    private fun requireNative() = assertTrue(NativeLib.available, "tessera_native failed to load: ${NativeLib.loadError}")
    ...
    fun libraryLoadsAndReportsVersion() {
        ...
        println("tessera_native ${NativeLib.versionString} on ${NativeLib.platformDir}: gf256 kernel=${Gf256Native.implementation}, lib=${NativeLib.libraryPath}")
    }
