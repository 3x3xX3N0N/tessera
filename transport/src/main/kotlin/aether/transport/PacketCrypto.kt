...
import aether.core.KeyPhaseState
 ...
 *
 *   secretC2S = HKDF(sessionKey, "aether-v0.3 c2s")      secretS2C = HKDF(sessionKey, "aether-v0.3 s2c")
...
internal class PacketCrypto(sessionKey: ByteArray, val isClient: Boolean) {
    ...
    /** The peer's sending direction; follows the peer's key phase (see AetherConnection.openShort). Builds it if needed. */
    ...
    companion object {
        const val LABEL_C2S = "aether-v0.3 c2s"
        const val LABEL_S2C = "aether-v0.3 s2c"
